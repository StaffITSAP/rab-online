...
<head>
  ...
  <style>
    ...
    td, th { border: 1px solid #000; padding: 4px 6px; font-size: 9px; vertical-align: top; line-height: 1.15; }

    .ttd { text-align: center; vertical-align: top; height: 100px; font-size: 12px; }
    .ttd-table, .ttd-table td { border: none; }

    .logo-cell { width: 8%; padding: 2px; text-align: center; vertical-align: middle; }
    .logo-cell img { width: 100%; height: auto; display: block; margin: 0 auto; }
    ...
    .item-table td, .item-table th { word-break: break-word; white-space: normal; }

    /* Multi-column list (untuk Amplop/Kartu/Kemeja) */
    .multi-column-container { width:100%; margin-top:8px; overflow:hidden; }
    .column-item { float:left; box-sizing:border-box; padding-right:2px; }
    ...
    .download-link { color:#0066cc; text-decoration: underline; font-size:8px; display:inline-block; margin-top:2px; }
    .lampiran-image { max-height:200px; max-width:100%; object-fit:contain; margin-top:5px; border:1px solid #ccc; }
    .file-info { font-size:8px; color:#666; margin-top:2px; }
  </style>
</head>
<body>
...
@php
  ...
  if ($totalColumns <= 1)      $columnClass = 'col-width-1';
  elseif ($totalColumns == 2)  $columnClass = 'col-width-2';
  elseif ($totalColumns == 3)  $columnClass = 'col-width-3';
  elseif ($totalColumns == 4)  $columnClass = 'col-width-4';
  elseif ($totalColumns == 5)  $columnClass = 'col-width-5';
  else                         $columnClass = 'col-width-6';
...
<table class="section-table item-table" style="font-size:9px;">
  ...
  <tbody>
    ...
    @empty
      <tr><td colspan="6" align="center">Belum ada data kebutuhan.</td></tr>
    @endforelse
  </tbody>
  <tfoot>
    <tr>
